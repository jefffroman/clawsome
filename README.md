<img src="https://raw.githubusercontent.com/jefffroman/clawsome/2026.8.25/clawsome-logo.png" alt="Clawsome" width="80" align="left">
...
→ See [`docs/setup.md`](https://github.com/jefffroman/clawsome/blob/2026.8.25/docs/setup.md) for prerequisites, install notes
...
→ See [`docs/architecture.md`](https://github.com/jefffroman/clawsome/blob/2026.8.25/docs/architecture.md) for the full mental
...
→ See [`docs/configuration.md`](https://github.com/jefffroman/clawsome/blob/2026.8.25/docs/configuration.md) for the full key-by-key
reference.
...
→ See [`docs/operations.md`](https://github.com/jefffroman/clawsome/blob/2026.8.25/docs/operations.md).
...
→ See [`docs/extending.md`](https://github.com/jefffroman/clawsome/blob/2026.8.25/docs/extending.md).
